            ...
            <div class="mb-4 bg-red-100 border-l-4 border-red-500 text-red-700 p-4" role="alert">
                ...
                <ul class="mt-1 list-disc list-inside text-sm">
                    @foreach ($errors->all() as $error)
                        @if (
                            $error !== $errors->first('nocivitas') &&
                                $error !== $errors->first('password') &&
                                $error !== $errors->first('loginError'))
                            <li>{{ $error }}</li>
                        @endif
                    @endforeach
                </ul>
            ...
            <div class="mb-5">
                ...
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="input-icon h-5 w-5 text-slate-400" viewBox="0 0 500 500"
                    ...
                    <input autocomplete="off" id="nocivitas" placeholder="NIK/NIM"
                        ...
                        name="nocivitas" type="text" value="{{ old('nocivitas') }}" required autofocus>
                </div>
                @error('nocivitas')
                    <p class="text-red-500 text-xs mt-1.5 -translate-y-3">{{ $message }}</p>
                @enderror

                <div class="mb-6 @error('nocivitas') mt-1 @else mt-0 @enderror">
                    ...
                    <div class="relative">
                        ...
                        <input autocomplete="current-password" id="password" placeholder="Password"
