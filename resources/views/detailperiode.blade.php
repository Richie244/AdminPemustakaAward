                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            <div class="flex items-center text-gray-700 mb-3">
                                <svg class="w-6 h-6 mr-3 text-blue-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9.663 17h4.673M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M14.964 14.964L9 9M15 9l-6 6"></path>
                                </svg>
                                <h2 class="text-xl font-semibold">Skor Default</h2>
                            </div>
                            <div class="bg-blue-50 p-4 rounded-lg">
                                <p class="text-sm text-blue-700">
                                    {{ $namaJenisBobotFromController[8] ?? 'Aksara Dinamika (Review Buku)' }}</p>
                                <p class="text-3xl font-bold text-blue-600">{{ $skorAksaraDinamikaDefault }} <span
                                        class="text-lg font-normal">poin</span></p>
                            </div>
                        </div>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            <div class="flex items-center text-gray-700 mb-4">
                                <svg class="w-6 h-6 mr-3 text-green-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7.014A8.003 8.003 0 0122 12c0 3.771-2.502 6.94-6.014 7.753A8.003 8.003 0 0012 22a8.003 8.003 0 00-5.986-2.247C3.502 18.94 1 15.771 1 12c0-1.604.468-3.112 1.258-4.427m2.828 11.084A8 8 0 0117.657 5.343M6.343 18.657A8 8 0 015.343 6.343">
                                    </path>
                                </svg>
                            ...
                            <ul class="space-y-2">
                                @forelse ($rangesKunjungan as $range)
                                    ...
                                    <li
                                        class="flex justify-between items-center bg-green-50 p-3 rounded-md hover:bg-green-100 transition-colors">
                                        <div class="flex items-center flex-grow">
                                            ...
                                            <span class="text-sm text-gray-700">Range
                                                {{ $rangeItem->RANGE_AWAL ?? ($rangeItem->range_awal ?? 'N/A') }} -
                                                {{ $rangeItem->RANGE_AKHIR ?? ($rangeItem->range_akhir ?? 'N/A') }}</span>
                                        </div>
                                        <span
                                            class="text-sm font-semibold text-green-700 ml-2 flex-shrink-0">{{ $rangeItem->BOBOT ?? ($rangeItem->bobot ?? 'N/A') }}
                                            poin</span>
                                    </li>
                                @empty
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            <div class="flex items-center text-gray-700 mb-4">
                                <svg class="w-6 h-6 mr-3 text-indigo-500" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M12 6.253v11.494m0 0A7.5 7.5 0 0019.5 12H4.5a7.5 7.5 0 007.5 5.747z"></path>
                                </svg>
                            ...
                            <ul class="space-y-2">
                                @forelse ($rangesPinjaman as $range)
                                    @php $rangeItem = (object) $range; @endphp
                                    <li
                                        class="flex justify-between items-center bg-indigo-50 p-3 rounded-md hover:bg-indigo-100 transition-colors">
                                        <div class="flex items-center flex-grow">
                                        ...
                                        <span
                                            class="text-sm font-semibold text-indigo-700 ml-2 flex-shrink-0">{{ $rangeItem->BOBOT ?? ($rangeItem->bobot ?? 'N/A') }}
                                            poin</span>
                                    </li>
                                @empty
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-lg">
                            ...
                            <ul class="space-y-3">
                                @forelse ($poinKomponenUntukTampilan as $idBobot => $komponen)
                                    <li
                                        class="flex justify-between items-center bg-purple-50 p-3 rounded-md hover:bg-purple-100 transition-colors">
                                        <div class="flex items-center flex-grow min-w-0">
                                            <span class="mr-2 text-purple-600 flex-shrink-0">
                                                @if ($komponen['icon_key'] === 'kunjungan')
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                ...
                                                @elseif($komponen['icon_key'] === 'aksara_dinamika')
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                            d="M12 6.253v11.494m0 0A7.5 7.5 0 0019.5 12H4.5a7.5 7.5 0 007.5 5.747z">
                                                        </path>
                                                    </svg>
                                                @elseif($komponen['icon_key'] === 'pinjaman')
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                ...
                                                @elseif($komponen['icon_key'] === 'kegiatan')
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                ...
                                                @else
                                                    <svg class="w-5 h-5" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2" d="M7 7h10m0 0v10m0-10L7 17m10-10H7"></path>
                                                    </svg>
                                                @endif
                                            </span>
                                        ...
                                        <span
                                            class="text-sm font-semibold text-purple-700 ml-2 flex-shrink-0">{{ $komponen['nilai'] ?? 'N/A' }}
                                            poin</span>
                                    </li>
                                @empty
                                    <li class="text-sm text-gray-500">Belum ada komponen poin maksimum yang ditentukan.
                                    </li>
                                @endforelse
                            </ul>
                        </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between">
                                            <div class="flex items-center mb-2 sm:mb-0 flex-grow min-w-0">
                                                <span
                                                    class="mr-2 p-2 rounded-full flex-shrink-0 
                                            ...
                                            @else bg-amber-100 text-amber-600 @endif">
                                                ...
                                                <div class="truncate">
                                                    <h4 class="font-semibold text-gray-800 text-sm truncate">
                                                        {{ $rewardItem->processed_bentuk ?? 'N/A' }}
                                                        <span class="text-xs text-gray-500">(Level
                                                            {{ $rewardItem->processed_level ?? 'N/A' }})</span>
                                                    </h4>
                                                    <p class="text-xs text-gray-500">Min.
                                                        {{ $rewardItem->skor_minimal ?? 'N/A' }} Poin</p>
                                                </div>
                                            </div>
                                            <div class="text-sm text-gray-600 text-left sm:text-right ml-2 flex-shrink-0">
                                                <span
                                                    class="font-medium">{{ $rewardItem->processed_slot ?? 'N/A' }}</span>
                                                Slot Tersedia
                                            </div>
                                        </div>
                                    </div>
                                @empty
                                    <p class="text-sm text-gray-500">Belum ada level reward yang ditentukan untuk periode
                                        ini.</p>
                                @endforelse
                            </div>
                        </div>
