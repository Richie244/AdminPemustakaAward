        ...
        <div class="bg-white p-6 shadow-lg rounded-xl overflow-hidden">
            <div class="flex flex-col sm:flex-row justify-between items-center mb-6 pb-4 border-b border-gray-200 gap-4">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
                    ...
                    {{-- Tombol Master Perusahaan --}}
                    <a href="{{ route('master-perusahaan.index') }}"
                       class="bg-green-500 hover:bg-green-600 text-white px-5 py-2.5 rounded-lg shadow-md hover:shadow-lg flex items-center gap-2 transition-all duration-150 ease-in-out transform hover:scale-105 text-sm sm:text-base w-full sm:w-auto justify-center">
